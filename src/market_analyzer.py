    ...
    def _get_market_statistics(self, overview: MarketOverview):
        ...
        try:
            ...
            while True:
                ...
                params = {"page": page, "num": page_size, "sort": "symbol", "asc": 1, "node": "hs_a", "_s_r_a": "page"}
                ...
                for key, value in data.items():
                    ...
                    if len(parts) >= 6:
                        ...
                        try:
                            ...
                            valid_items.append({"name": name, "change_pct": change_pct})
    ...
    def _get_north_flow(self, overview: MarketOverview):
        ...
        try:
            ...
            if data.get("data"):
                ...
                logger.info(
                    f"[大盘] 北向资金净流入: {north_flow:.2f}亿 " f"(沪股通:{hk2sh/1e8:.2f}亿 深股通:{hk2sz/1e8:.2f}亿)"
                )
            else:
